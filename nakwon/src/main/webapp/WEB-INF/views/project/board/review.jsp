...
/*폰트*/
	...
	#nav #ahref {text-decoration:none;color:#fce8c5;display:block;font-size:40px;font-weight:bold;padding :20px;}
	
	#nav #ahrefcourse:hover {color:#fce8c5;}
...
<div class="board">
<div class="boardtitle">리뷰게시판</div>
<table id="noticetbl">
	<thead>
	<tr>
	<th><h2>NO</h2></th>
	...
	<th><h2>DATE</h2></th>
	 ...
	 <c:forEach items="${list}" var="list">
            <tr onclick="location.href='http://localhost:8031/reviewRead?RVCode=<c:out value="${list.RVCode }"/>'">
            
            	<td align="center"><c:out value="${list.RVCode}"/></td>
            	<%-- <a href="${list.menuDetailCode }" class="aaaa"> --%>
                <td align="center"><c:out value="${list.RVTitle}"/></td>
                <td align="center"><c:out value="${list.RVDate}"/></td>
            </tr>
</c:forEach> 
</table>
...
$(".pagination li a").on("click", function(event){
	...
	jobForm.attr("action","/project/board/review").attr("method", "get");
	jobForm.submit();
});
</script>
</html>
