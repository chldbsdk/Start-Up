...
<li class="topli"><a href="#" onclick="location.href='http://localhost:8031/QnA'">고객의 소리</a></li>
<li class="topli"><a href="#" onclick="location.href='http://localhost:8031/notice'">공지</a></li>
</ul></div>
</body>
</html> 